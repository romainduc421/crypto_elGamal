...
class EuclideTest {
    ...
    void euclideEtenduTestRight() {
        BigInteger[] results = Euclide.euclideEtendu(BigInteger.valueOf(325), BigInteger.valueOf(145));
    ...
    void euclideEtenduTestCrosscheck(){
        ...
        BigInteger[] resultats = Euclide.euclideEtendu(a,b);
    ...
    void euclidePrime(){
        assertDoesNotThrow(() -> {
            ...
            Euclide.euclideCompute(BigInteger.valueOf(21523894), b);
        });
    }

    @Test
    void euclideNotPrime(){
        assertThrows(EuclideException.class, () -> Euclide.euclideCompute(BigInteger.valueOf(81), BigInteger.valueOf(9)));
    }
